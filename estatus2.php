...
<?php
		...
		if(isset($_POST['btnregistrar'])){
			...
			$querymodificar = mysqli_query($conn, "UPDATE productos SET repartidorEn='$prorep1',numeroguia='$prodes1',paque='$procat',estatus='$proest1',fecha_entrega='$proent1' WHERE id = '$proid1'");
